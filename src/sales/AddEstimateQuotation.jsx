import "./AddEstimateQuotation.css";
...
const AddEstimateQuotation = () => {
  ...
  const [
    isFromEstimateQuotationDashboard,
    setIsFromEstimateQuotationDashboard,
  ] = useState(false);
  ...
  const [estimateNumber, setEstimateNumber] = useState("RS-00001");
...
Thank you for your business!`;
  ...
  const generateAndDownloadPDF = async () => {
    try {
      ...
      const opt = {
        margin: [10, 10, 10, 10],
        filename: `Estimate_${partyName || "Customer"}_${
      ...
      <html>
        <head>
          ...
          <style>
            ...
            .add-estimate-quotation-preview { max-width: 800px; margin: 0 auto; }
            table { width: 100%; border-collapse: collapse; margin: 10px 0; }
            th, td { border: 1px solid #ddd; padding: 8px; text-align: left; }
            th { background-color: #f2f2f2; }
            .add-estimate-quotation-header { text-align: center; margin-bottom: 20px; }
            .add-estimate-quotation-title { text-align: center; color: #333; }
            .add-estimate-quotation-details { margin: 20px 0; }
            .add-estimate-quotation-summary-item { display: flex; justify-content: space-between; margin: 5px 0; }
            .add-estimate-quotation-total-row { font-weight: bold; background-color: #f9f9f9; }
            @media print {
              body { margin: 0; }
              .add-estimate-quotation-no-print { display: none; }
            }
          </style>
        </head>
        <body>
  ...
  const incrementEstimateNumber = (currentEstimateNumber) => {
    ...
    const match = currentEstimateNumber.match(/^([A-Z]+)-(\d+)$/);
    ...
    if (!isNaN(currentEstimateNumber)) {
      return parseInt(currentEstimateNumber, 10) + 1;
    }
  ...
  const handleSaveNew = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setEstimateNumber((prevNumber) => incrementEstimateNumber(prevNumber));
  ...
  return (
    <div className="add-estimate-quotation-container">
      {/* Header Section */}
      <div className="add-estimate-quotation-header-section">
        <div className="add-estimate-quotation-header-section-left">
          <span className="add-estimate-quotation-label">
            Add Estimate & Quotation
          </span>
        </div>
        <div className="add-estimate-quotation-header-section-right">
          <button
      ...
      <div className="main-content">
        ...
        <div className="add-estimate-quotation-left-column">
          <div className="add-estimate-quotation-input-section">
            <div className="add-estimate-quotation-customer-fields">
              <div className="add-estimate-quotation-input-group">
            ...
            <div className="add-estimate-quotation-items-section">
              <table className="add-estimate-quotation-items-table">
                <thead>
                  <tr>
                    <th className="add-estimate-quotation-header-cell">#</th>
                    <th className="add-estimate-quotation-header-cell">ITEM</th>
                    <th className="add-estimate-quotation-header-cell">QTY</th>
                    <th className="add-estimate-quotation-header-cell add-estimate-quotation-price-unit-header">
                      <div className="add-estimate-quotation-price-unit-split">
                        <div className="add-estimate-quotation-price-label">
                          PRICE/UNIT
                        </div>
                        <div className="add-estimate-quotation-tax-type-select">
                          <select
                            className="add-estimate-quotation-header-tax-select"
                            value={headerTaxType}
                            onChange={(e) =>
                    ...
                    <th className="add-estimate-quotation-header-cell add-estimate-quotation-discount-header">
                      <div className="add-estimate-quotation-discount-split">
                        <div className="add-estimate-quotation-discount-label">
                          DISCOUNT (%)
                        </div>
                        <div className="add-estimate-quotation-discount-sub-split">
                          <div className="add-estimate-quotation-discount-percent-label">
                            %
                          </div>
                          <div className="add-estimate-quotation-discount-amount-label">
                            AMOUNT
                          </div>
                        </div>
                      </div>
                    </th>
                    <th className="add-estimate-quotation-header-cell add-estimate-quotation-tax-header">
                      <div className="add-estimate-quotation-tax-split">
                        <div className="add-estimate-quotation-tax-label">
                          TAX
                        </div>
                        <div className="add-estimate-quotation-tax-sub-split">
                          <div className="add-estimate-quotation-tax-percent-label">
                            %
                          </div>
                          <div className="add-estimate-quotation-tax-amount-label">
                            AMOUNT
                          </div>
                        </div>
                      </div>
                    </th>
                    <th className="add-estimate-quotation-header-cell">
                      TOTAL
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {itemInputs.map((item, index) => (
                    <tr
                      key={item.id}
                      className="add-estimate-quotation-item-row"
                    >
                      <td className="add-estimate-quotation-cell add-estimate-quotation-item-id-cell">
                        <span className="add-estimate-quotation-item-id">
                          {item.id}
                        </span>
                        {(itemInputs.length > 1 || index === 0) && (
                          <button
                            className="add-estimate-quotation-remove-row-btn"
                      ...
                      <td className="add-estimate-quotation-cell add-estimate-quotation-item-name-cell">
                        <ItemsDropdown
                          value={item.itemName}
                          onChange={(value) =>
                      ...
                      <td className="add-estimate-quotation-cell">
                        <input
                          type="number"
                          placeholder="0"
                          value={item.quantity}
                      ...
                      <td className="add-estimate-quotation-cell add-estimate-quotation-price-unit-cell">
                        <input
                          type="number"
                          placeholder="0.00"
                          value={item.price}
                          ...
                          className="add-estimate-quotation-price-input"
                        />
                      </td>
                      <td className="add-estimate-quotation-cell add-estimate-quotation-discount-cell">
                        <div className="add-estimate-quotation-discount-split">
                          <div className="add-estimate-quotation-discount-sub-split">
                            <input
                              type="number"
                              ...
                              className="add-estimate-quotation-discount-input"
                            />
                            <input
                              type="number"
                              placeholder="0.00"
                              ...
                              className="add-estimate-quotation-discount-amount-input"
                            />
                          </div>
                        </div>
                      </td>
                      <td className="add-estimate-quotation-cell add-estimate-quotation-tax-cell">
                        <div className="add-estimate-quotation-tax-split">
                          <div className="add-estimate-quotation-tax-sub-split">
                            <select
                              ...
                              className="add-estimate-quotation-tax-select"
                            >
                            ...
                            <input
                              ...
                              readOnly
                              className="add-estimate-quotation-tax-amount-input"
                            />
                          </div>
                        </div>
                      </td>
              ...
              <div
                className="add-estimate-quotation-add-row-btn"
                onClick={addNewRow}
              >
                + Add Row
              </div>
        ...
        <div className="add-estimate-quotation-right-column">
          <div
            className="add-estimate-quotation-estimate-preview"
            ref={estimatePreviewRef}
          >
            <h2 className="add-estimate-quotation-estimate-title">
              Estimate/Quotation
            </h2>

            <div className="add-estimate-quotation-estimate-details">
              <div className="add-estimate-quotation-details-header">
                <div className="add-estimate-quotation-estimate-for">
                  <h4>Estimate For</h4>
                  <p>{partyName || "Customer Name"}</p>
                  <p>{partyPhone || "Contact No. "}</p>
                </div>

                <div className="add-estimate-quotation-estimate-info">
                  <h4>Estimate Details</h4>
                  <div className="add-estimate-quotation-info-row">
                    <span>Ref. No. {estimateNumber}</span>
                  </div>
                  <div className="add-estimate-quotation-info-row">
              ...
              {itemInputs.some((item) => item.itemName.trim() !== "") && (
                <div className="add-estimate-quotation-estimate-items-table">
                  <table className="add-estimate-quotation-items-preview-table">
                    <thead>
                      <tr>
                        <th>#</th>
                        <th>Item Name</th>
                    ...
                    <tbody>
                      {itemInputs
                        ...
                        .map((item, index) => (
                          <tr
                            key={item.id}
                            className="add-estimate-quotation-estimate-item-preview-row"
                          >
                            <td>{index + 1}</td>
                            <td>{item.itemName}</td>
                            ...
                            <td>
                              ...
                              <span className="add-estimate-quotation-discount-percentage">
                                ({item.discount || 0}%)
                              </span>
                            </td>
                            <td>
                              ...
                              <span className="add-estimate-quotation-gst-percentage">
                                (
                      ...
                      {/* Total Row */}
                      <tr className="add-estimate-quotation-total-row">
                        <td colSpan="2">
                          <strong>Total</strong>
                        </td>
                        <td>
                    ...
                    <tfoot>
                      <tr>
                        <td
                          colSpan="7"
                          className="add-estimate-quotation-no-padding-cell"
                        >
                          <div className="add-estimate-quotation-tax-summary-wrapper">
                            <div className="add-estimate-quotation-tax-summary-title">
                              Tax Summary:
                            </div>
                            <table className="add-estimate-quotation-tax-summary-table">
                              <thead>
                                {(() => {
                                  ...
                                  return (
                                    <>
                                      <tr>
                                        <th
                                          rowSpan="2"
                                          className="add-estimate-quotation-ts-col-hsn"
                                        >
                                          HSN/ SAC
                                        </th>
                                        <th
                                          rowSpan="2"
                                          className="add-estimate-quotation-ts-col-taxable"
                                        >
                                          Taxable amount (₹)
                                        </th>
                                        {hasIGST ? (
                                          <th
                                            colSpan="2"
                                            className="add-estimate-quotation-ts-col-igst"
                                          >
                                            IGST
                                          </th>
                                        ) : (
                                          <>
                                            <th
                                              colSpan="2"
                                              className="add-estimate-quotation-ts-col-cgst"
                                            >
                                              CGST
                                            </th>
                                            <th
                                              colSpan="2"
                                              className="add-estimate-quotation-ts-col-sgst"
                                            >
                                              SGST
                                            </th>
                                          </>
                                        ...
                                        <th
                                          rowSpan="2"
                                          className="add-estimate-quotation-ts-col-total"
                                        >
                                          Total Tax (₹)
                                        </th>
                                      </tr>
                                      <tr>
                                        {hasIGST ? (
                                          <>
                                            <th className="add-estimate-quotation-ts-col-rate">
                                              Rate (%)
                                            </th>
                                            <th className="add-estimate-quotation-ts-col-amt">
                                              Amt (₹)
                                            </th>
                                          </>
                                        ) : (
                                      ...
                                      {taxGroupsArray.map((group, index) => {
                                        if (group.isIGST) {
                                          ...
                                          return (
                                            <tr key={index}>
                                              <td></td>
                                              <td className="add-estimate-quotation-ta-right">
                                                {formatNumberWithCommas(
                                                  group.taxableAmount.toFixed(2)
                                                )}
                                              </td>
                                              <td className="add-estimate-quotation-ta-center">
              ...
              <div className="add-estimate-quotation-estimate-bottom-section">
                <div className="add-estimate-quotation-estimate-left-column-content">
                  <div className="add-estimate-quotation-amount-words">
                    <p>
                      <strong>Estimate Amount In Words: </strong>{" "}
                      {numberToWords(calculateSubTotal())}
                    </p>
                  </div>
                  <div className="add-estimate-quotation-terms">
                    <p>
                ...
                <div className="add-estimate-quotation-right-column-content">
                  <div className="add-estimate-quotation-summary-item">
                    <strong>Total</strong>
                    <span>
                      ₹ {formatNumberWithCommas(calculateSubTotal().toFixed(2))}
              ...
              <div className="add-estimate-quotation-footer">
                <div className="add-estimate-quotation-company-signature">
                  <p>For : {companyName}</p>
            ...
            <div className="add-estimate-quotation-action-buttons">
              <button
                className="add-estimate-quotation-save-new-btn"
                onClick={handleSaveNew}
              >
                Save & New
              </button>
              <div className="add-estimate-quotation-action-icons">
                <button
...
export default AddEstimateQuotation;
